...
url ="http://agemanlabo.com/anisonbest100"
itunsUrl = "https://itunes.apple.com/search?"
tapnowUrl = "http://api.tapnow.jp/tapnow/itunesapi/api/search?"
    ...
    if numPage <= 5:   
        ...
        for i in range(minNum):
            try:
                ...
                # r = rq.get(itunsUrl,params=payload)
                # print(r.text)
